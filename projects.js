var projects = [
  // ─── HTML Projects ────────────────────────────────────────────────────────
  {
    ...
    description:
      "A fully accessible audio player built with semantic HTML. Includes controls for play, pause, and volume adjustments.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Displays a catalog of books in a structured HTML table. Features headings and rows for easy reading.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Homepage for a bookstore highlighting books, categories, and featured items. Designed with clear layout.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "A blog page dedicated to cats, showcasing posts, images, and a comments section with a clean layout.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Interactive app for browsing cat images. Features responsive design and user-friendly interface.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Complete checkout page with forms and pricing summary for e-commerce users.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Blog documenting coding tutorials, projects, and learning experiences with clear content structure.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Displays upcoming events with schedules and RSVP options, focusing on clarity and usability.",
    codeFiles: [
      { name: "Event Hub.html", src: "HTML/Event Hub.html", lang: "html" },
    ],
  },
  {
    category: "HTML",
    ...
    description:
      "Organized table showing final exam schedules. Easy to read and structured layout.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "A simple animated heart icon using HTML elements. Demonstrates basic styling and layout.",
    codeFiles: [
      { name: "Heart Icon.html", src: "HTML/Heart Icon.html", lang: "html" },
    ],
  },
  {
    category: "HTML",
    ...
    description:
      "Interactive feedback form for hotel services with semantic HTML inputs.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Page featuring HTML audio and video players with play, pause, and volume controls.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Demonstrates embedding multiple videos using iframe with responsive layout.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "HTML page listing popular web browsers using structured content and headings.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Page for writing and displaying movie reviews with structured layout for readability.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Interactive multimedia player supporting audio and video playback with clear controls.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Page sharing job tips and career advice with readable layout and structured content.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Displays recipes with ingredients and instructions using clear HTML structure.",
    codeFiles: [
      { name: "Recipe Page.html", src: "HTML/Recipe Page.html", lang: "html" },
    ],
  },
  {
    category: "HTML",
    ...
    description:
      "Simple survey form collecting user data using accessible HTML inputs.",
    codeFiles: [
      { name: "Survey Form.html", src: "HTML/Survey Form.html", lang: "html" },
    ],
  },
  {
    category: "HTML",
    ...
    description:
      "Displays conference schedule in a structured table with session times and speakers.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Homepage for a travel agency highlighting destinations and services using clear layout.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    description:
      "Page compiling multiple videos for preview with responsive iframe layout.",
    codeFiles: [
      {
  ...
  // ─── CSS Projects ─────────────────────────────────────────────────────────
  {
    ...
    description:
      "Styled availability or calendar table with hover states and responsive design.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Financial layout styled with CSS featuring responsive columns and clean structure.",
    codeFiles: [
      { name: "index.html", src: "CSS/Balance Sheet/index.html", lang: "html" },
    ],
  },
  {
    category: "CSS",
    ...
    description:
      "Visually appealing blog post card layout using hover and transition effects.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "CSS-styled inventory display for books with responsive tables and clean visuals.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Professional business card layout using CSS typography and spacing techniques.",
    codeFiles: [
      { name: "index.html", src: "CSS/Business Card/index.html", lang: "html" },
    ],
  },
  {
    category: "CSS",
    ...
    description:
      "Styled cafe menu with sections for food and drinks, featuring hover effects.",
    codeFiles: [
      { name: "index.html", src: "CSS/Cafe Menu/index.html", lang: "html" },
    ],
  },
  {
    category: "CSS",
    ...
    description:
      "Creative CSS art project displaying a cat painting using shapes and layering.",
    codeFiles: [
      { name: "index.html", src: "CSS/Cat Painting/index.html", lang: "html" },
    ],
  },
  {
    category: "CSS",
    ...
    description:
      "CSS art project showing a city skyline using gradients, shapes, and responsive design.",
    codeFiles: [
      { name: "index.html", src: "CSS/City Skyline/index.html", lang: "html" },
    ],
  },
  {
    category: "CSS",
    ...
    description:
      "CSS-styled email template emphasizing confidentiality with layout and typography.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Visually styled contact form featuring inputs, buttons, and responsive layout.",
    codeFiles: [
      { name: "index.html", src: "CSS/Contact Form/index.html", lang: "html" },
    ],
  },
  {
    category: "CSS",
    ...
    description:
      "Interactive CSS page for coloring markers with hover and responsive design.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "A CSS-styled event flyer showcasing event details and attractive layout.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Page highlighting product or app features with structured sections and styling.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "CSS art project displaying a Ferris wheel using shapes, rotation, and layering techniques.",
    codeFiles: [
      { name: "index.html", src: "CSS/Ferris Wheel/index.html", lang: "html" },
    ],
  },
  {
    category: "CSS",
    ...
    description:
      "Interactive game page where a penguin moves through obstacles using CSS animations.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Responsive photo gallery using CSS Flexbox with hover and animation effects.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "CSS layout for a game settings panel with organized controls and toggles.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "CSS-styled greeting card with decorative elements, layout, and hover effects.",
    codeFiles: [
      { name: "index.html", src: "CSS/Greeting Card/index.html", lang: "html" },
    ],
  },
  {
    category: "CSS",
    ...
    description:
      "Creative CSS project showing a house painting using layering and shapes.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "CSS-styled form for submitting job applications with responsive fields.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Magazine-style layout using CSS grid and typography for organized content.",
    codeFiles: [
      { name: "index.html", src: "CSS/Magazine/index.html", lang: "html" },
    ],
  },
  {
    category: "CSS",
    ...
    description:
      "CSS animation project simulating the orbit of the moon around the earth.",
    codeFiles: [
      { name: "index.html", src: "CSS/Moon Orbit/index.html", lang: "html" },
    ],
  },
  {
    category: "CSS",
    title: "Newpaper Layout",
    iframeSrc: "CSS/Newpaper Layout/index.html",
    description:
      "CSS grid layout mimicking a newspaper with multiple columns and articles.",
    codeFiles: [
      {
        name: "index.html",
        src: "CSS/Newpaper Layout/index.html",
        lang: "html",
      },
    ],
  },
  {
    ...
    description:
      "Single newspaper article styled with CSS for readability and layout.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Portfolio page showcasing projects, skills, and contact info using CSS layout.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Interactive CSS piano layout allowing users to click keys and play notes.",
    codeFiles: [
      { name: "index.html", src: "CSS/Piano/index.html", lang: "html" },
    ],
  },
  {
    category: "CSS",
    ...
    description:
      "Landing page for a product using CSS for layout, images, and call-to-action buttons.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Interactive quiz page styled with CSS, showing questions and multiple choice answers.",
    codeFiles: [
      { name: "index.html", src: "CSS/Quiz Webpage/index.html", lang: "html" },
    ],
  },
  {
    category: "CSS",
    ...
    description:
      "CSS-styled registration form with inputs, buttons, and responsive layout.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Page displaying colored boxes with CSS layout, hover effects, and responsive design.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "CSS-styled documentation page showcasing text, code blocks, and clear sectioning.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "CSS-styled tribute page highlighting a person or event with images and text layout.",
    codeFiles: [
      { name: "index.html", src: "CSS/Tribute Page/index.html", lang: "html" },
    ],
  },
  ...
  // DOM Manipulation Events (Web)
  {
    ...
    description:
      "Interactive app that reacts to user actions with fun emoji animations using DOM events.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    iframeSrc:
      "Javascript/DOM Manipulation Events/Favorite Icon Toggler/index.html",
    description:
      "Toggle favorite icons on items using DOM click events and class manipulation.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    iframeSrc:
      "Javascript/DOM Manipulation Events/Football Team Cards/index.html",
    description:
      "Displays football player cards with filtering and DOM manipulation for dynamic content.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Image lightbox viewer that opens full-screen previews on click using DOM events.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    iframeSrc:
      "Javascript/DOM Manipulation Events/Music Instrument Filter/index.html",
    description:
      "Filter music instruments by category using dynamic DOM manipulation and event listeners.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    iframeSrc:
      "Javascript/DOM Manipulation Events/Real Time Counter/index.html",
    description:
      "Real-time counter with increment, decrement, and reset functionality via DOM events.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    iframeSrc:
      "Javascript/DOM Manipulation Events/Rock, Paper, Scissors Game/index.html",
    description:
      "Classic Rock, Paper, Scissors game built with DOM events and game logic in JavaScript.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    iframeSrc:
      "Javascript/DOM Manipulation Events/Story Telling App/index.html",
    description:
      "Interactive story telling app that builds narratives dynamically through user choices.",
    codeFiles: [
      {
        name: "index.html",
  ...
  // Asynchronous JavaScript (Web)
  {
    ...
    description:
      "Fetches and displays freeCodeCamp authors asynchronously using the Fetch API.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    iframeSrc:
      "Javascript/Asynchronous JavaScript/fCC Forum Leaderboard/index.html",
    description:
      "Fetches freeCodeCamp forum data and displays a leaderboard asynchronously.",
    codeFiles: [
      {
        name: "index.html",
  ...
  // Regex (Web)
  {
    category: "JavaScript",
    title: "RegEx Sandbox",
    iframeSrc: "Javascript/Basic Ragex/RegEx Sandbox/index.html",
    description:
      "Interactive sandbox for testing regular expressions with live match highlighting.",
    codeFiles: [
      {
        name: "index.html",
        src: "Javascript/Basic Ragex/RegEx Sandbox/index.html",
        lang: "html",
      },
      {
        name: "script.js",
        src: "Javascript/Basic Ragex/RegEx Sandbox/script.js",
        lang: "javascript",
      },
      {
        name: "styles.css",
        src: "Javascript/Basic Ragex/RegEx Sandbox/styles.css",
        lang: "css",
      },
    ],
  },
  ...
  // Classes (Web)
  {
    ...
    description:
      "A shopping cart built with JavaScript classes, supporting add, remove, and total calculations.",
    codeFiles: [
      {
        name: "index.html",
  ...
  // Debugging (Web)
  {
    ...
    iframeSrc:
      "Javascript/Debugging/Random Background Color Changer/index.html",
    description:
      "Generates random background colors on button click. Demonstrates debugging techniques.",
    codeFiles: [
      {
        name: "index.html",
  ...
  // Functional Programming (Web)
  {
    ...
    iframeSrc:
      "Javascript/Functional Programming/Recipe Ingredient Convertor/index.html",
    description:
      "Converts recipe ingredient quantities using functional programming concepts.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    iframeSrc:
      "Javascript/Functional Programming/Sorting Visualizer/index.html",
    description:
      "Visual representation of sorting algorithms built with functional programming principles.",
    codeFiles: [
      {
        name: "index.html",
  ...
  // JavaScript And Accessibility (Web)
  {
    ...
    iframeSrc:
      "Javascript/JavaScript And Accessibility/Note Taking App/index.html",
    description:
      "Accessible note-taking app with create, edit, and delete functionality using DOM manipulation.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    iframeSrc:
      "Javascript/JavaScript And Accessibility/Planet Tablists/index.html",
    description:
      "Tabbed interface displaying planet information with accessible keyboard navigation.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    iframeSrc:
      "Javascript/JavaScript And Accessibility/Theme Switcher/index.html",
    description:
      "Accessible theme switcher toggling between light and dark mode with ARIA attributes.",
    codeFiles: [
      {
        name: "index.html",
  ...
  // Misc Web Projects (JavaScript)
  {
    ...
    description:
      "Fetches live weather data from an API and displays current conditions and forecasts.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Interactive drum machine with clickable pads and keyboard support for beat creation.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Checks whether a given word or phrase is a palindrome, ignoring spaces and punctuation.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Converts Markdown text to HTML in real time with a live side-by-side preview.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Detects and flags spam content in user-submitted messages using regex pattern matching.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Personal developer portfolio page showcasing projects and skills with smooth navigation.",
    codeFiles: [
      {
        name: "index.html",
  ...
  },
  {
    ...
    description:
      "Converts decimal numbers to binary using recursion with animated call-stack visualization.",
    codeFiles: [
      {
        name: "index.html",
  ...
  // Code-only JavaScript Projects
  {
    ...
    iframeSrc: null,
    description:
      "Translates golf scores into their named equivalents (Birdie, Eagle, Bogey, etc.).",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Randomly picks a lunch option from a list using array methods.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Manages a shopping list with add and remove operations using JavaScript arrays.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Simulates bank account operations including deposit, withdrawal, and balance tracking.",
    codeFiles: [
      {
        name: "script.js",
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Translates English words and sentences into Pig Latin using regex and string manipulation.",
    codeFiles: [
      {
        name: "Pig Latin Translator.js",
        src: "Javascript/Basic Ragex/Pig Latin Translator.js",
        lang: "javascript",
      },
    ],
  },
  {
    ...
    iframeSrc: null,
    description:
      "Replaces specific words in a string intelligently using regular expressions.",
    codeFiles: [
      {
        name: "Smart Word Replacement Function.js",
        src: "Javascript/Basic Ragex/Smart Word Replacement Function.js",
        lang: "javascript",
      },
    ],
  },
  {
    ...
    iframeSrc: null,
    description:
      "Converts camelCase and other string formats into spinal-case using regex.",
    codeFiles: [
      {
        name: "Spinal Case Convertor.js",
        src: "Javascript/Basic Ragex/Spinal Case Convertor.js",
        lang: "javascript",
      },
    ],
  },
  {
    ...
    iframeSrc: null,
    description:
      "Generates random fortune predictions using boolean logic and random number generation.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Evaluates logical expressions and returns boolean results with explanations.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "A simple math bot that performs arithmetic operations and answers number questions.",
    codeFiles: [
      {
        name: "Mathbot.js",
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Converts dates between different formats using the JavaScript Date object.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "A function-based calculator supporting addition, subtraction, multiplication, and division.",
    codeFiles: [
      {
        name: "Calculator.js",
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Implements a card counting algorithm to track the running count during a card game.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Converts temperature values between Celsius and Fahrenheit using a pure function.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Masks email addresses for privacy by replacing parts of the string with asterisks.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Checks whether a person qualifies for a loan based on income, credit score, and debt.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Implements a curried sum function that accepts optional arguments flexibly.",
    codeFiles: [
      {
        name: "script.js",
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Manages a library of books using higher-order functions like map, filter, and reduce.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Calculates the sum of prime numbers in a range using higher-order functions.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Encodes and decodes messages using the Caesar cipher shifting algorithm.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Simulates a cash register that calculates change using available denominations.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Converts integers to Roman numeral representation using lookup tables and loops.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Validates US telephone numbers using regular expressions and string parsing.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Generates pyramid shapes from characters in the console using loops and string concatenation.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Tracks student grades and calculates averages, letter grades, and class statistics.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Converts strings to title case by capitalising the first letter of each word.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "LeetCode challenge: implements a counter function that increments on each call.",
    codeFiles: [
      {
        name: "Counter.js",
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "LeetCode challenge: implements memoization to cache function results for performance.",
    codeFiles: [
      {
        name: "Memoize.js",
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "LeetCode challenge: implements a debounce function to limit the rate of function calls.",
    codeFiles: [
      {
        name: "Debounce.js",
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "LeetCode challenge: flattens a nested array to a specified depth using recursion.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Calculates the factorial of a number using both iterative and recursive approaches.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Analyzes a sentence and returns word count, character count, and longest word.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Text-based quiz game using JavaScript objects to store questions, answers, and scores.",
    codeFiles: [
      {
        name: "Quiz Game.js",
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Tracks recipes and their ingredients using JavaScript objects and array methods.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Generates all permutations of a string or array using recursive backtracking.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "A simple chatbot that greets users based on the time of day using string manipulation.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "A chatbot that answers basic questions using conditional logic and string matching.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Simulates a voting system that tallies votes and announces the winner.",
    codeFiles: [
      {
        name: "script.js",
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Manages project ideas using JavaScript classes with add, remove, and display methods.",
    codeFiles: [
      {
  ...
  // ─── Python Projects ───────────────────────────────────────────────────────
  {
    ...
    iframeSrc: null,
    description:
      "Tracks income and expenses across spending categories with a visual bar chart summary.",
    codeFiles: [
      { name: "Budget App.py", src: "Python/Budget App.py", lang: "python" },
    ],
  },
  {
    category: "Python",
    ...
    iframeSrc: null,
    description:
      "Encrypts and decrypts messages using the Caesar cipher shift algorithm.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Implements binary search to efficiently find elements in a sorted list.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Implements the quicksort algorithm with pivot selection and partitioning.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Traverses a graph level-by-level using a queue-based BFS implementation.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Traverses a graph by exploring as far as possible before backtracking using DFS.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Implements a singly linked list with insert, delete, and traversal operations.",
    codeFiles: [
      { name: "Linked List.py", src: "Python/Linked List.py", lang: "python" },
    ],
  },
  {
    category: "Python",
    ...
    iframeSrc: null,
    description:
      "Implements a hash table with collision handling using chaining.",
    codeFiles: [
      { name: "Hash Table.py", src: "Python/Hash Table.py", lang: "python" },
    ],
  },
  {
    category: "Python",
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Finds roots of equations numerically using the bisection method.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Solves the Tower of Hanoi puzzle recursively and prints each move.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Solves the N-Queens problem using backtracking to place queens on a chessboard.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Calculates the area and perimeter of rectangles and squares using Python classes.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Calculates discounted prices based on percentage off and promotional rules.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Validates ISBN-10 and ISBN-13 numbers using checksum verification.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Validates patient medical data fields such as age, blood pressure, and BMI ranges.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Simulates an email inbox with compose, read, and delete operations using OOP.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Tracks RPG character stats like health, attack, and defense using Python classes.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Catalogues movies, books, and music using inheritance and polymorphism.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Manages a musical instrument shop inventory with stock and pricing using OOP.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Tracks employee salaries and calculates totals, averages, and raises.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Generates numeric patterns and sequences like triangles and Pascal's triangle.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Calculates the Nth Fibonacci number using both iterative and memoized recursive methods.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Extracts and validates PIN codes from text input using string parsing techniques.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Models planets with properties like mass, radius, and gravity using Python classes.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Defines a player interface for a game with movement, health, and action methods.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Creates an RPG character with stats, leveling, and combat using Python OOP.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Sorts a list by repeatedly selecting the minimum element and placing it in order.",
    codeFiles: [
      {
  ...
  },
  {
    ...
    iframeSrc: null,
    description:
      "Manages user configuration settings with read, write, and reset operations.",
    codeFiles: [
      {
  ...
  // ─── React Projects ────────────────────────────────────────────────────────
  {
    ...
    description:
      "Interactive color picker built with React hooks that lets users select and preview colors.",
    codeFiles: [
      {
        name: "index.jsx",
  ...
  },
  {
    ...
    description:
      "Converts between currencies in real time using React state management and input handling.",
    codeFiles: [
      {
        name: "index.jsx",
  ...
  },
  {
    ...
    description:
      "Event RSVP form built with React, managing attendee state and confirmation messages.",
    codeFiles: [
      { name: "index.jsx", src: "React/Event RSVP/index.jsx", lang: "jsx" },
      { name: "index.html", src: "React/Event RSVP/index.html", lang: "html" },
      { name: "styles.css", src: "React/Event RSVP/styles.css", lang: "css" },
    ],
  },
  {
    category: "React",
    ...
    description:
      "Search and filter a list of fruits in real time using React controlled inputs and state.",
    codeFiles: [
      {
        name: "index.jsx",
  ...
  },
  {
    ...
    description:
      "A mood board app where users can add, move, and remove mood cards using React state.",
    codeFiles: [
      { name: "index.jsx", src: "React/Mood Board/index.jsx", lang: "jsx" },
      { name: "index.html", src: "React/Mood Board/index.html", lang: "html" },
      { name: "styles.css", src: "React/Mood Board/styles.css", lang: "css" },
    ],
  },
  {
    category: "React",
    ...
    description:
      "Generates one-time passwords with a countdown timer using React hooks and state.",
    codeFiles: [
      {
        name: "index.jsx",
  ...
  },
  {
    ...
    description:
      "A reusable mega navbar component with dropdowns and responsive design built in React.",
    codeFiles: [
      {
        name: "index.jsx",
  ...
  },
  {
    ...
    description:
      "A reusable profile card React component displaying avatar, name, bio, and social links.",
    codeFiles: [
      {
        name: "index.jsx",
  ...
  {
    category: "React",
    title: "Reuseable Footer",
    iframeSrc: "React/Reuseable Footer/index.html",
    description:
      "A configurable reusable footer React component with links, branding, and copyright info.",
    codeFiles: [
      {
        name: "index.jsx",
        src: "React/Reuseable Footer/index.jsx",
        lang: "jsx",
      },
      {
        name: "index.html",
        src: "React/Reuseable Footer/index.html",
        lang: "html",
      },
      {
        name: "styles.css",
        src: "React/Reuseable Footer/styles.css",
        lang: "css",
      },
    ],
  },
  {
    ...
    description:
      "A shopping list React app with add, check-off, and delete item functionality.",
    codeFiles: [
      {
        name: "index.jsx",
  ...
  },
  {
    ...
    description:
      "A fun superhero registration form built with React controlled components and validation.",
    codeFiles: [
      {
        name: "index.jsx",
  ...
  },
  {
    ...
    description:
      "Classic Tic-Tac-Toe game with win detection and restart functionality built in React.",
    codeFiles: [
      {
        name: "index.jsx",
  ...
  },
  {
    ...
    description:
      "Toggles between different text states on button click using React useState hook.",
    codeFiles: [
      {
        name: "index.jsx",
